...
SET(OpenCV_INCLUDE_DIRS "/var/www/opencv/src/OpenCV-2.3.1/build" "/var/www/opencv/src/OpenCV-2.3.1/include" "/var/www/opencv/src/OpenCV-2.3.1/include/opencv")
...
SET(OpenCV_LIB_DIR /var/www/opencv/src/OpenCV-2.3.1/build/lib)
...
# ==============================================================
if(NOT "/var/www/opencv/src/OpenCV-2.3.1" STREQUAL  "")
    foreach(__CVLIB ${OpenCV_LIB_COMPONENTS})
        # We only need the "core",... part here: "opencv_core" -> "core"
        STRING(REGEX REPLACE "opencv_(.*)" "\\1" __MODNAME ${__CVLIB})
        INCLUDE_DIRECTORIES("/var/www/opencv/src/OpenCV-2.3.1/modules/${__MODNAME}/include")
    endforeach()
endif()
...
IF (NOT OpenCV_SHARED)
    ...
    LINK_DIRECTORIES("/var/www/opencv/src/OpenCV-2.3.1/build/3rdparty/lib")

    set(OpenCV_LIBS dl;m;pthread;rt  gtk-x11-2.0;gdk-x11-2.0;atk-1.0;gio-2.0;pangoft2-1.0;pangocairo-1.0;gdk_pixbuf-2.0;cairo;pango-1.0;freetype;fontconfig;gobject-2.0;glib-2.0;gthread-2.0;rt;glib-2.0;gstbase-0.10;gstreamer-0.10;gobject-2.0;gmodule-2.0;gthread-2.0;rt;xml2;glib-2.0;gstapp-0.10;gstbase-0.10;gstreamer-0.10;gobject-2.0;gmodule-2.0;gthread-2.0;rt;xml2;glib-2.0;gstvideo-0.10;gstbase-0.10;gstreamer-0.10;gobject-2.0;gmodule-2.0;gthread-2.0;rt;xml2;glib-2.0;avcodec;dl;X11;Xext;Xfixes;va;jack;asound;SDL;xvidcore;x264;vorbisenc;vorbis;theoraenc;theoradec;ogg;opencore-amrwb;opencore-amrnb;mp3lame;faac;z;avutil;m;avformat;avcodec;dl;X11;Xext;Xfixes;va;jack;asound;SDL;xvidcore;x264;vorbisenc;vorbis;theoraenc;theoradec;ogg;opencore-amrwb;opencore-amrnb;mp3lame;faac;z;avutil;m;avutil;m;swscale;avutil;m;v4l1 ${OpenCV_LIBS})
    set(OpenCV_EXTRA_COMPONENTS /usr/lib/i386-linux-gnu/libjpeg.so /usr/lib/i386-linux-gnu/libpng.so;/usr/lib/i386-linux-gnu/libz.so libtiff libjasper /usr/lib/i386-linux-gnu/libz.so)
